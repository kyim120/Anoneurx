...
import { FileCheck, ArrowLeft, Search, Loader2, CheckCircle, Clock, X, Award, Download } from "lucide-react";
...
const HackathonVerify = () => {
  ...
  const handleSearch = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await applicationApi.search(searchQuery, 'hackathon');
      ...
      if (response.success && response.data) {
        ...
        toast.error("No hackathon application found with this ID or email");
      }
    } catch (error) {
  ...
  const getStatusIcon = (status: string) => {
    switch (status) {
      ...
      case "shortlisted": return <Award className="w-5 h-5" />;
                  ...
                  <div className="space-y-4">
                    <div className="grid md:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-white font-semibold">{foundApplication.targetTitle || 'N/A'}</p>
                      </div>
                      <div>
                      ...
                      <div>
                        ...
                        <p className="text-white font-semibold">
                          {foundApplication.applicantData?.teamMembers?.length || 1} member(s)
                        </p>
                      </div>
                      <div>
                    ...
                    {foundApplication.applicantData?.projectIdea && (
                      <div>
                        <p className="text-gray-400 text-sm mb-2">Project Idea</p>
                    ...
                    {foundApplication.status === 'accepted' && (
                      <div className="mt-6 p-6 bg-green-500/10 border border-green-500/30 rounded-lg">
                        ...
                        <p className="text-gray-300 mb-4">
                          Your hackathon application has been accepted. Download your participation certificate below.
                        </p>
        ...
        <div className="relative z-10 min-h-screen flex items-center justify-center px-4 py-12">
          <div className="w-full max-w-2xl">
            <div className="text-center mb-12">
              <div className="mx-auto w-20 h-20 bg-gradient-to-r from-purple-500 to-pink-600 rounded-full flex items-center justify-center mb-6">
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-white mb-6 bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">
                Verify Hackathon Application
              </h1>
              <p className="text-xl text-gray-200 max-w-2xl mx-auto leading-relaxed">
                Enter your application ID or email to check your hackathon status
              </p>
            </div>
              ...
              <CardContent className="p-8">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="relative">
                      <Input
                        ...
                        className="bg-white/10 border-white/30 text-white placeholder-gray-300 h-14 text-lg px-6 rounded-xl focus:border-purple-400 focus:ring-2 focus:ring-purple-400/50"
                        placeholder="e.g., HACK-2024-001 or john@email.com"
                ...
                <div className="mt-8 p-6 bg-white/5 rounded-xl border border-white/10">
                  ...
                  <ul className="text-gray-300 text-sm space-y-2">
                    <li>• Use your application ID (e.g., HACK-2024-001)</li>
